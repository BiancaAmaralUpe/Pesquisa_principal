# ======================================================================================
# matriz_confusao_regressao_logistica.py
# ======================================================================================
# Responsabilidade:
# - Gerar matriz de confusão absoluta da Regressão Logística
# - Gerar matriz de confusão normalizada da Regressão Logística
...
def gerar_matriz_confusao_regressao_logistica(
    y_real: pd.Series,
    y_predito,
    caminho_saida: str,
    nome_arquivo: str,
    ...
    """
    Gera e salva matriz de confusão da Regressão Logística.
...
def gerar_matrizes_confusao_regressao_logistica(
    y_real: pd.Series,
    y_predito,
    caminho_saida: str,
) -> None:
    ...
    gerar_matriz_confusao_regressao_logistica(
        y_real=y_real,
        y_predito=y_predito,
